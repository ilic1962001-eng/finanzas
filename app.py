...
# ==========================================
# ENTRADA DE DATOS (SIDEBAR CON SESSION STATE)
# ==========================================
with st.sidebar:
    st.markdown("<h3 style='color:#d4af37;'>Flujo de Capital</h3>", unsafe_allow_html=True)
    ingreso_fijo_bruto = st.number_input("INGR. FIJO ($)", min_value=0.0, step=10.0, key="ingreso_fijo")
    ingreso_var_bruto = st.number_input("INGR. VARIABLE ($)", min_value=0.0, step=10.0, key="ingreso_var")
    st.divider()
